...
from br_pipeline import collect_backupradar_snapshot
...
def main(argv: list[str] | None = None) -> int:
    ...
    snapshot = collect_backupradar_snapshot(context)
    output_path = args["output_path"] or run_paths["backupradar_snapshot_file"]
