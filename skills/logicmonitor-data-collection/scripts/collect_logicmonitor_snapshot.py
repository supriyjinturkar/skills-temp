...
from lm_pipeline import collect_logicmonitor_snapshot
...
def main(argv: list[str] | None = None) -> int:
    ...
    snapshot = collect_logicmonitor_snapshot(context)
    output_path = args["output_path"] or run_paths["logicmonitor_snapshot_file"]
